...
-- 导出 jymanager 的数据库结构
DROP DATABASE IF EXISTS `jymanager`;
...
INSERT INTO `t_ys` (`ys_id`, `ys_type`, `ys_name`, `ys_subname`, `item_name`, `item_year`, `item_type`, `item_buy_way`, `item_tax`, `item_cur_amount`, `item_next_amount`, `item_own_user`, `item_input_datetime`, `item_input_user`, `isvalid`) VALUES
	('YS-20160506145300000', '生产系统维护预算', '统一支付系统维护', '维护-软件外包预算', '开发预算', '2016', '软件外包', '单一来源', 6, 2000000.00, 0.00, 'qinqiang', '2016-06-08 15:10:42', 'admin', '生效'),
	('YS-20160513092500000', '生产系统维护预算', '物联网PBOSS系统维护', '维护-软件外包预算', '开发预算', '2016', '软件外包', '单一来源', 6, 1000000.00, 0.00, 'wangyl', '2016-05-13 09:26:36', 'zhangsl', '生效');
